...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "technew@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "technew API";

        private String description = "technew API documentation";
