...
class PostGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Post entity")
        ...
        .repeat(2) {
            ...
            .post("/api/posts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "decription":"SAMPLE_TEXT", "avatar":"SAMPLE_TEXT", "status":null, "createdDate":"2020-01-01T00:00:00.000Z", "view":"0"}""")).asJSON
            .check(status.is(201))
