...
class AuthorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Author entity")
        ...
        .repeat(2) {
            ...
            .post("/api/authors")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "birthDay":"2020-01-01T00:00:00.000Z", "address":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "avatar":"SAMPLE_TEXT", "status":null, "aboutMe":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
